...
banner() {
	cat <<- EOF
		${ORANGE}
		${ORANGE} _     _   _ _____ ___________ ___________    ___ ______ _   _ 
		${ORANGE}| |   | | | /  __ \_   _|  ___|  ___| ___ \  / _ \|  _  \ | | |
		${ORANGE}| |   | | | | /  \/ | | | |_  | |__ | |_/ / / /_\ \ | | | | | |
		${ORANGE}| |   | | | | |     | | |  _| |  __||    /  |  _  | | | | | | |
		${ORANGE}| |___| |_| | \__/\_| |_| |   | |___| |\ \  | | | | |/ /\ \_/ /
		${ORANGE}\_____/\___/ \____/\___/\_|   \____/\_| \_| \_| |_/___/  \___/ 
		${ORANGE}                                        ______                 
		${ORANGE}                                       |______|                ${RED}Version : ${__version__}
		
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Lucifer-ADV${WHITE}
	EOF
}
...
banner_small() {
	cat <<- EOF
		${BLUE}
		${BLUE} __       __  __   ______    ________  ______   ______   ______             ________   ______   __   __     
		${BLUE}/_/\     /_/\/_/\ /_____/\  /_______/\/_____/\ /_____/\ /_____/\           /_______/\ /_____/\ /_/\ /_/\    
		${BLUE}\:\ \    \:\ \:\ \\:::__\/  \__.::._\/\::::_\/_\::::_\/_\:::_ \ \          \::: _  \ \\:::_ \ \\:\ \\ \ \   
		${BLUE} \:\ \    \:\ \:\ \\:\ \  __   \::\ \  \:\/___/\\:\/___/\\:(_) ) )_         \::(_)  \ \\:\ \ \ \\:\ \\ \ \  
		${BLUE}  \:\ \____\:\ \:\ \\:\ \/_/\  _\::\ \__\:::._\/ \::___\/_\: __ \`\\ \  _______\:: __  \ \\:\ \ \ \\:\_/.:\ \ 
		${BLUE}   \:\/___/\\:\_\:\ \\:\_\ \ \/__\::\__/\\:\ \    \:\____/\\ \ \`\ \ \/______/\\:.\ \  \ \\:\/.:| |\ ..::/ / 
		${BLUE}    \_____\/ \_____\/ \_____\/\________\/ \_\/     \_____\/ \_\/ \_\/\__::::\/ \__\/\__\/ \____/_/ \___/_(  
		${WHITE} ${__version__}
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN} Author   ${RED}:  ${ORANGE}ANMATH RAJ S ${RED}[ ${ORANGE}LUCIFER14333 ${RED}]
		${GREEN} Github   ${RED}:  ${CYAN}githun.com/Lucifer14333
		${GREEN} Social   ${RED}:  ${CYAN}@anmath_tamil
